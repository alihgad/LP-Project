    ...
    <>
      <section className="bg-[#1A1a1a] py-20 text-white ">
        <div className="container relative">
          ...
          <h5 className="mb-5 tracking-[0.4em]"> ABOUT US</h5>
          <p>
            At LA Projects, we are a dedicated development agency committed to
            creating exceptional digital experiences that drive success for our
            clients. With a passion for innovation and a team of skilled
