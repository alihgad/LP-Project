...
const PhoneNumberInput: React.FC<PhoneInputProps> = ({
  ...
  const validatePhoneNumber = (
    ...
    let standardLength = exampleNumberLengthByCountryCode ? exampleNumberLengthByCountryCode +1 : exampleNumberLengthByCountryCode 

    if (phoneNumber?.length !== standardLength ) {
      return false;
    }
